...
import { update_Location } from '../../store/actions/auth';
      ...
      <>
        ...
        >
          <Form
            ...
            <img src={require('../../../src/assets/location.jpg')} alt="Personal" width="200" height="200" style={{ float: "left", margin: "12px 4px 0 0" }} />
            <Form.Item
