...
import { update_ProffesionalInfo, loadUser } from '../../store/actions/auth';
      ...
      <>
        ...
        >
          <Form
            ...
            <img src={require('../../../src/assets/pro.jpg')} alt="Professional" width="200" height="200" style={{ float: "left", margin: "12px 4px 0 0" }} />
            <Form.Item
