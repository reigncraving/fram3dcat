...
import FrameList from '../frame/components/frameList';
        ...
        <Meta
          ...
          description={
            <>
              ...
              <a href={"https://" + this.props.profile.website} target="_blank" rel="noopener noreferrer">{this.props.profile.website}</a>
            </>
          }
        />
        <br />
