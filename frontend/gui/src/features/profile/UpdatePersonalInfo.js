...
import { update_PersonalInfo } from '../../store/actions/auth';
      ...
      <>
        ...
        >
          <Form
            ...
            <img
              src={require('../../../src/assets/personal.jpg')}
              alt="Personal"
              width="200"
              height="200"
              style={{ float: "left", margin: "12px 4px 0 0" }}
            />
            <Form.Item
      ...
      <>
        ...
        >
          <Form
            ...
            onFinish={this.onSubmit}
            validateMessages={this.validateMessages}>
            <img src={require('../../../src/assets/company.jpg')} alt="company" width="100" height="100" style={{ float: "left", margin: "12px 4px 0 0" }} />
